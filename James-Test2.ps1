...
ForEach($subscription in $subscriptions) {
	...
	ElseIf ($subscription.Name -eq "JH-SWS") {
	...
	ElseIf ($subscription.Name -eq "JH-MALONECENTER") {
	...
	ElseIf ($subscription.Name -eq "JH-SOM-DOM") {
	...
	ElseIf ($subscription.Name -eq "JH-ACH-MARCOM") {
	...
	ElseIf ($subscription.Name -eq "JH-GENOMICS") {
...
<#
	ElseIf ($subscription.Name -eq "JH-ANSWERALS") {
...
#>
	...
	ElseIf ($subscription.Name -eq "JH-TIC") {
	...
	ElseIf ($subscription.Name -eq "JH-KSAS") {
	...
	ElseIf ($subscription.Name -eq "JH-RADIOLOGY") {
